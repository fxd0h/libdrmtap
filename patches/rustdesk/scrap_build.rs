...
fn link_homebrew_m1(name: &str) -> PathBuf {
    ...
    if target_os != "macos" || target_arch != "aarch64" {
        println!("cargo:rustc-link-lib=yuv"); // panic!("Couldn.t find VCPKG_ROOT, also can't fallback to homebrew because it's only for macos aarch64.");
    }
...
fn gen_vcpkg_package(_package: &str, ffi_header: &str, generated: &str, regex: &str) {
